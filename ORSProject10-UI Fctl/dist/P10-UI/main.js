...
/* harmony import */ var _shopping_shopping_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./shopping/shopping.component */ "./src/app/shopping/shopping.component.ts");
/* harmony import */ var _shopping_shoppinglist_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./shopping/shoppinglist.component */ "./src/app/shopping/shoppinglist.component.ts");
...
/* harmony import */ var _payment_paymentlist_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./payment/paymentlist.component */ "./src/app/payment/paymentlist.component.ts");
...
var routes = [
    ...
    {
        path: 'shopping',
        component: _shopping_shopping_component__WEBPACK_IMPORTED_MODULE_36__["ShoppingComponent"]
    },
    {
        path: 'shopping/:id',
        component: _shopping_shopping_component__WEBPACK_IMPORTED_MODULE_36__["ShoppingComponent"]
    ...
    {
        path: 'shoppinglist',
        component: _shopping_shoppinglist_component__WEBPACK_IMPORTED_MODULE_37__["ShoppinglistComponent"]
    },
    {
        path: 'payment',
        component: _payment_payment_component__WEBPACK_IMPORTED_MODULE_38__["PaymentComponent"]
    },
    {
        path: 'paymentlist',
        component: _payment_paymentlist_component__WEBPACK_IMPORTED_MODULE_39__["PaymentlistComponent"]
    },
    {
        path: 'payment/:id',
        component: _payment_payment_component__WEBPACK_IMPORTED_MODULE_38__["PaymentComponent"]
...
/* harmony import */ var _shopping_shopping_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./shopping/shopping.component */ "./src/app/shopping/shopping.component.ts");
/* harmony import */ var _shopping_shoppinglist_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./shopping/shoppinglist.component */ "./src/app/shopping/shoppinglist.component.ts");
/* harmony import */ var _payment_payment_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./payment/payment.component */ "./src/app/payment/payment.component.ts");
/* harmony import */ var _payment_paymentlist_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./payment/paymentlist.component */ "./src/app/payment/paymentlist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _shopping_shopping_component__WEBPACK_IMPORTED_MODULE_48__["ShoppingComponent"],
                _shopping_shoppinglist_component__WEBPACK_IMPORTED_MODULE_49__["ShoppinglistComponent"],
                _payment_payment_component__WEBPACK_IMPORTED_MODULE_50__["PaymentComponent"],
                _payment_paymentlist_component__WEBPACK_IMPORTED_MODULE_51__["PaymentlistComponent"]
            ],
            imports: [
...
module.exports = "<app-navbar></app-navbar>\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n</style>\r\n\r\n<style type=\"text/css\">\r\n  .log1 {\r\n    padding-top: 13%;\r\n  }\r\n\r\n  .input-group-addon {\r\n    box-shadow: 9px 8px 7px #001a33;\r\n\r\n  }\r\n</style>\r\n\r\n<div class=\"row \" style=\"padding-top: 2%; padding-bottom:2%;\r\n\r\nbackground: url(assets/files/wall.jpg) no-repeat center center;\r\nbackground-attachment: fixed;\r\nbackground-size: cover;width:100%;\r\n  height: auto;\">\r\n\r\n  <div class=\"col-sm-4\"></div>\r\n  <div class=\"col-sm-4\">\r\n    <div class=\"card\">\r\n      <div class=\"card-body input-group-addon grad \">\r\n        <form name=\"userForm\">\r\n          <h2 *ngIf=\"!form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Add Order' |\r\n            translate }}</h2>\r\n          <h2 *ngIf=\"form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Update Order'\r\n            |\r\n            translate }}</h2>\r\n\r\n\r\n          <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{form.message}}\r\n          </div>\r\n\r\n          <div *ngIf=\"form.error && form.message != null\" class=\"alert alert-danger alert-dismissible\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{form.message}}\r\n          </div>\r\n\r\n         \r\n\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Order Name' | translate }}</b>\r\n              <span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-user-circle grey-text\"></i> </div>\r\n                </div>\r\n                <input type=\"text\" name=\"on\" [(ngModel)]=\"form.data.orderName\" class=\"form-control\"\r\n                  placeholder=\"{{'Enter First Name'  | translate }}\">\r\n              </div>\r\n            </div><span *ngIf=\"form.inputerror.orderName != null\" class=\"alertRedColor\" style=\" color: red;\">\r\n              {{'ordername'| translate}} </span>\r\n            <!-- <span class=\"alertRedColor\"> {{form.inputerror.firstName}} </span> -->\r\n          </div>\r\n\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Order Type' | translate }}</b>\r\n              <span class=\"required-field\"></span></span>\r\n\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i> </div>\r\n                </div>\r\n                <input type=\"text\" name=\"ot\" [(ngModel)]=\"form.data.orderType\" class=\"form-control\"\r\n                  placeholder=\"{{'Enter Order Type'  | translate }}\">\r\n              </div>\r\n            </div><span *ngIf=\"form.inputerror.orderType != null\" class=\"alertRedColor\" style=\" color: red;\">\r\n              {{'ordertype'| translate}} </span>\r\n            <!-- <span class=\"alertRedColor\"> {{form.inputerror.lastName}} </span> -->\r\n          </div>\r\n\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Order Id' | translate }}</b>\r\n              <span class=\"required-field\"></span></span>\r\n\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-envelope grey-text\"></i> </div>\r\n                </div>\r\n                <input type=\"text\" name=\"orderId\" [(ngModel)]=\"form.data.orderId\" class=\"form-control\"\r\n                  placeholder=\"{{'Enter Order Id'  | translate }}\">\r\n              </div>\r\n            </div><span *ngIf=\"form.inputerror.orderId != null\" class=\"alertRedColor\" style=\" color: red;\"> {{'OrderId'|\r\n              translate}} </span>\r\n            <!-- <span class=\"alertRedColor\"> {{form.inputerror.loginId}} </span> -->\r\n          </div>\r\n\r\n          <span class=\"pt-2\"><b>{{'OrderDate' | translate }}</b>\r\n            <span class=\"required-field\"></span></span>\r\n\r\n          <div class=\"col-sm-12\">\r\n            <div class=\"input-group\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-table grey-text\"></i> </div>\r\n              </div>\r\n              <input type=\"date\" name=\"orderDate\" [value]=\"form.data.orderDate | date:'yyyy-MM-dd'\"\r\n                (input)=\"form.data.orderDate=parseDate($event.target.value)\" class=\"form-control form-control-sm\"\r\n                required />\r\n            </div>\r\n          </div>\r\n          <span *ngIf=\"form.inputerror.orderDate != null\" class=\"alertRedColor\" style=\" color: red;\"> {{'orderDate'|\r\n            translate}} </span>\r\n          <!-- <span class=\"alertRedColor\"> {{form.inputerror.dob}} </span> -->\r\n      \r\n\r\n\r\n      <div>\r\n        <span class=\"pt-2\"><b>{{'Status' | translate }}</b>\r\n          <span class=\"required-field\"></span></span>\r\n\r\n        <div class=\"col-sm-12\">\r\n          <div class=\"input-group\">\r\n            <div class=\"input-group-prepend\">\r\n              <div class=\"input-group-text\"><i class=\"fa fa-bell grey-text\"></i> </div>\r\n            </div>\r\n            <select class=\"form-control\" id=\"status\" name=\"status\" [(ngModel)]=\"form.data.status\">\r\n              <option [ngValue]=\"\" value=\"undefined\">{{' Select Status' | translate }}</option>\r\n              <option value=\"Active\">{{'Active' | translate }} </option>\r\n              <option value=\"Inactive\">{{'Inactive' | translate }} </option>\r\n            </select>\r\n          </div>\r\n        </div><span *ngIf=\"form.inputerror.status != null\" class=\"alertRedColor\" style=\" color: red;\"> {{'status'|\r\n          translate}} </span>\r\n        <!-- <span class=\"alertRedColor\"> {{form.inputerror.status}} </span> -->\r\n      </div>\r\n      <div class=\"row pt-2 pl-2 pb-3\">\r\n\r\n        <div class=\"col-md-3\"></div>\r\n\r\n\r\n        <div class=\"pt-2\">\r\n          <button *ngIf=\"!form.data.id>0\" (click)=\"onUpload()\" class=\"btn btn-success mr-2\">\r\n            {{'Save' | translate }}</button>\r\n        </div>\r\n\r\n        <div class=\"col-md-1\"></div>\r\n\r\n        <div class=\"pt-2\">\r\n          <button *ngIf=\"form.data.id>0\" (click)=\"onUpload()\" class=\"btn btn-success mr-2\">\r\n            {{'Update' | translate }}</button>\r\n        </div>\r\n        <div class=\"pt-2\">\r\n          <a class=\"btn btn-warning mr-1\" type=\"button\" [routerLink]=\"['/orderlist']\"\r\n            style=\"text-decoration: none; color: white;\">{{'List' | translate }}</a>\r\n        </div>\r\n      </div>\r\n\r\n\r\n      </form>\r\n    </div>\r\n  </div>\r\n</div>\r\n</div>\r\n<app-footer></app-footer>"
...
var OrderComponent = /** @class */ (function (_super) {
    ...
    OrderComponent.prototype.validateForm = function (form) {
        var flag = true;
        var validator = this.serviceLocator.dataValidator;
        flag = flag && validator.isNotNullObject(form.paymentId);
        console.log(form.paymentId);
        flag = flag && validator.isNotNullObject(form.orderName);
        console.log(form.paymentName);
        flag = flag && validator.isNotNullObject(form.orderType);
        console.log(form.paymentType);
        flag = flag && validator.isNotNullObject(form.orderId);
...
var PaymentlistComponent = /** @class */ (function (_super) {
    ...
    function PaymentlistComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.PAYMENT, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        return _this;
...
module.exports = "<app-navbar></app-navbar>\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n\r\n  .log1 {\r\n    padding-top: 13%;\r\n  }\r\n\r\n  .input-group-addon {\r\n    box-shadow: 9px 8px 7px #001a33;\r\n  }\r\n\r\n  .required-field {\r\n    color: red;\r\n    font-weight: bold;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n\r\n  .card-body {\r\n    padding: 2rem;\r\n  }\r\n\r\n  .input-group-text i {\r\n    width: 1.5rem;\r\n  }\r\n\r\n  .btn-primary, .btn-success, .btn-warning {\r\n    width: 100%;\r\n  }\r\n\r\n  .form-control {\r\n    height: calc(2.25rem + 2px);\r\n  }\r\n</style>\r\n\r\n<div class=\"row\" style=\"\r\n  padding: 2% 0;\r\n  background: url('assets/files/wall.jpg') no-repeat center center;\r\n  background-attachment: fixed;\r\n  background-size: cover;\r\n  width: 100%;\r\n  height: auto;\">\r\n  <div class=\"col-sm-4\"></div>\r\n  <div class=\"col-sm-4\">\r\n    <div class=\"card\">\r\n      <div class=\"card-body input-group-addon grad\">\r\n        <form name=\"userForm\">\r\n          <h2 *ngIf=\"!form.data.id\" class=\"text-primary font-weight-bold text-center\">{{ 'Add Shopping' | translate }}</h2>\r\n          <h2 *ngIf=\"form.data.id\" class=\"text-primary font-weight-bold text-center\">{{ 'Update Shopping' | translate }}</h2>\r\n\r\n          <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{ form.message }}\r\n          </div>\r\n\r\n          <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{ form.message }}\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label><b>{{ 'Payment Name' | translate }}</b><span class=\"required-field\">*</span></label>\r\n            <div class=\"input-group\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i></div>\r\n              </div>\r\n              <select class=\"form-control\" name=\"paymentId\" [(ngModel)]=\"form.data.paymentId\" aria-label=\"ngSelected\">\r\n                <option [ngValue]=\"undefined\">{{ 'Select Payment' | translate }}</option>\r\n                <option *ngFor=\"let obj of form.preload.paymentList\" [value]=\"obj.key\">{{ obj.value }}</option>\r\n              </select>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.paymentId\" class=\"alertRedColor\">{{ 'payment' | translate }}</span>\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label><b>{{ 'Shopping Id' | translate }}</b><span class=\"required-field\">*</span></label>\r\n            <div class=\"input-group\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-user-circle grey-text\"></i></div>\r\n              </div>\r\n              <input type=\"text\" name=\"si\" [(ngModel)]=\"form.data.shoppingId\" class=\"form-control\" placeholder=\"{{ 'Enter shopping Id' | translate }}\">\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.shoppingId\" class=\"alertRedColor\">{{ 'shoppingId' | translate }}</span>\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label><b>{{ 'Product Type' | translate }}</b><span class=\"required-field\">*</span></label>\r\n            <div class=\"input-group\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-venus grey-text\"></i></div>\r\n              </div>\r\n              <select class=\"form-control\" name=\"productType\" id=\"productType\" [(ngModel)]=\"form.data.productType\" style=\"cursor: pointer;\">\r\n                <option [ngValue]=\"undefined\">{{ 'Please select' | translate }}</option>\r\n                <option value=\"Electronics\">{{ 'Electronics' | translate }}</option>\r\n                <option value=\"Clothing\">{{ 'Clothing' | translate }}</option>\r\n              </select>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.productType\" class=\"alertRedColor\">{{ 'productType' | translate }}</span>\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label><b>{{ 'Product Name' | translate }}</b><span class=\"required-field\">*</span></label>\r\n            <div class=\"input-group\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-envelope grey-text\"></i></div>\r\n              </div>\r\n              <input type=\"text\" name=\"productname\" [(ngModel)]=\"form.data.productName\" class=\"form-control\" placeholder=\"{{ 'Enter Product Name' | translate }}\">\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.productName\" class=\"alertRedColor\">{{ 'productname' | translate }}</span>\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label><b>{{ 'Amount' | translate }}</b><span class=\"required-field\">*</span></label>\r\n            <div class=\"input-group\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i></div>\r\n              </div>\r\n              <input type=\"number\" name=\"amount\" [(ngModel)]=\"form.data.amount\" class=\"form-control\" placeholder=\"{{ 'Enter Amount' | translate }}\">\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.amount\" class=\"alertRedColor\">{{ 'amount' | translate }}</span>\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label><b>{{ 'Customer Name' | translate }}</b><span class=\"required-field\">*</span></label>\r\n            <div class=\"input-group\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-key grey-text\"></i></div>\r\n              </div>\r\n              <input type=\"text\" name=\"ctn\" [(ngModel)]=\"form.data.customerName\" class=\"form-control\" placeholder=\"{{ 'Enter Customer Name' | translate }}\">\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.customerName\" class=\"alertRedColor\">{{ 'customerName' | translate }}</span>\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label><b>{{ 'Shopping Date' | translate }}</b><span class=\"required-field\">*</span></label>\r\n            <div class=\"input-group\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-table grey-text\"></i></div>\r\n              </div>\r\n              <input type=\"date\" name=\"shoppingdate\" [value]=\"form.data.shoppingDate | date:'yyyy-MM-dd'\" (input)=\"form.data.shoppingDate=parseDate($event.target.value)\" class=\"form-control form-control-sm\" required>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.shoppingDate\" class=\"alertRedColor\">{{ 'shoppingDate' | translate }}</span>\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label><b>{{ 'Image' | translate }}</b><span class=\"required-field\">*</span></label>\r\n            <div class=\"col-sm-12\">\r\n              <div *ngIf=\"form.data.imageId\">\r\n                <img src=\"http://localhost:8084/Shopping/profilePic/{{form.data.id}}\" height=\"55\" width=\"80\">\r\n              </div>\r\n              <div *ngIf=\"!form.data.imageId\">\r\n                <img src=\"../../assets/files/default.jpg\" height=\"55\" width=\"80\">\r\n              </div>\r\n            </div>\r\n            <div class=\"input-group mt-2\">\r\n              <div class=\"input-group-prepend\">\r\n                <div class=\"input-group-text\"><i class=\"fa fa-picture-o grey-text\"></i></div>\r\n              </div>\r\n              <input type=\"file\" id=\"customFile\" name=\"imageId\" (change)=\"onFileSelect($event.target.files)\" accept=\"image/*\">\r\n              <span *ngIf=\"form.inputerror.image\" class=\"alertRedColor\">{{ form.inputerror.image }}</span>\r\n            </div>\r\n          </div>\r\n\r\n          <div class=\"row pt-2 pb-3 justify-content-center\">\r\n            <div class=\"col-md-4\">\r\n              <button *ngIf=\"!form.data.id\" (click)=\"onUpload()\" class=\"btn btn-success\">{{ 'Save' | translate }}</button>\r\n            </div>\r\n            <div class=\"col-md-4\">\r\n              <button *ngIf=\"form.data.id\" (click)=\"onUpload()\" class=\"btn btn-success\">{{ 'Update' | translate }}</button>\r\n            </div>\r\n            <div class=\"col-md-4\">\r\n              <a class=\"btn btn-warning\" type=\"button\" [routerLink]=\"['/shoppinglist']\">{{ 'List' | translate }}</a>\r\n            </div>\r\n          </div>\r\n        </form>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"col-sm-4\"></div>\r\n</div>\r\n<app-footer></app-footer>\r\n"
...
var ShoppingComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ShoppingComponent, _super);
    function ShoppingComponent(locator, route, httpClient) {
    ...
    ShoppingComponent.prototype.submit = function () {
        var _self = this;
        console.log('in submit');
        console.log(this.form);
        console.log(this.form.data);
    ...
    ShoppingComponent.prototype.submit1 = function () {
        var _self = this;
        console.log(this.form + "submit running start");
        console.log(this.form.data + "form data going to be submit");
        this.serviceLocator.httpService.post(this.api.search, this.form.data, function (res) {
    ...
    ShoppingComponent.prototype.onFileSelect = function (files) {
        this.fileToUpload = files.item(0);
        console.log(this.fileToUpload);
    };
    ShoppingComponent.prototype.onUpload = function (userform) {
        this.submit();
        console.log(this.form.data.id + '---- after submit');
    };
    ShoppingComponent.prototype.myFile = function () {
        var _this = this;
        console.log(this.form.data.id + 'after super.submit-----');
    ...
    ShoppingComponent.prototype.onSubmitProfile = function (fileToUpload, userform) {
        var formData = new FormData();
        var phone = null;
        formData.append('file', fileToUpload);
        console.log(this.form.data.id + 'this id number ======');
        return this.httpClient.post("http://localhost:8084/Shopping/profilePic/" + this.form.data.id, formData);
    };
    ShoppingComponent.prototype.validateForm = function (form) {
        var flag = true;
        var validator = this.serviceLocator.dataValidator;
        flag = flag && validator.isNotNullObject(form.paymentId);
        console.log(form.paymentId);
        ...
        flag = flag && validator.isNotNullObject(form.shoppingDate);
        console.log(form.lastName);
        flag = flag && validator.isNotNullObject(form.shoppingId);
        console.log(form.shoppingId);
        flag = flag && validator.isNotNullObject(form.shoppingDate);
        console.log(form.paymentId);
        return flag;
    };
    ShoppingComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
        console.log(form.id + 'populate form in shoppingcomponent');
        form.shoppingId = data.shoppingId;
        form.productType = data.productType;
        form.productName = data.productName;
        form.shoppingDate = data.shoppingDate;
        form.paymentId = data.paymentId;
        form.amount = data.amount;
        form.imageId = data.imageId;
        console.log(form.paymentId + 'populate form in shoppingcomponent');
        form.customerName = data.customerName;
    };
    ShoppingComponent.prototype.parseDate = function (dateString) {
        if (dateString) {
            return new Date(dateString);
        }
        return null;
    };
    ShoppingComponent.prototype.test = function () {
    };
...
/***/ "./src/app/shopping/shoppinglist.component.css":
/*!*****************************************************!*\
  !*** ./src/app/shopping/shoppinglist.component.css ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Nob3BwaW5nL3Nob3BwaW5nbGlzdC5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/shopping/shoppinglist.component.html":
/*!******************************************************!*\
  !*** ./src/app/shopping/shoppinglist.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n<style>\r\n  #nnn {\r\n    background: none;\r\n    border: none;\r\n    cursor: pointer;\r\n  }\r\n  .panel-heading {\r\n    height: 50px;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n  }\r\n  .search-inputs {\r\n    margin-top: 20px;\r\n  }\r\n  .search-inputs .form-control, .search-inputs .btn {\r\n    margin-bottom: 10px;\r\n  }\r\n  .content-wrapper {\r\n    background: url(assets/files/wall.jpg) no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: auto;\r\n    height: 105vh;\r\n    padding: 20px;\r\n  }\r\n  .table-responsive {\r\n    margin-top: 20px;\r\n  }\r\n</style>\r\n\r\n<div class=\"content-wrapper\">\r\n  <div class=\"container-fluid\">\r\n\r\n    <div class=\"panel panel-primary\">\r\n      <div class=\"panel-heading\">\r\n        <h1 class=\"text-primary font-weight-bold\">{{'Shopping List' | translate }}</h1>\r\n      </div>\r\n\r\n      <div class=\"row search-inputs p-1 justify-content-center\">\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.customerName\"\r\n            placeholder=\"{{'Search Customer Name' | translate}}\">\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"date\" class=\"form-control\" [(ngModel)]=\"form.searchParams.shoppingDate\"\r\n            placeholder=\"{{'Search Shopping Date' | translate}}\">\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.shoppingId\"\r\n            placeholder=\"{{'Search Shopping Id' | translate}}\">\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.productName\"\r\n            placeholder=\"{{'Search Product Name' | translate}}\">\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <select class=\"form-control\" name=\"paymentId\" [(ngModel)]=\"form.searchParams.paymentId\" aria-label=\"ngSelected\">\r\n            <option [ngValue]=\"\" value=\"undefined\">{{'Select Payment' | translate }}</option>\r\n            <option *ngFor=\"let obj of form.preload.paymentList\" [value]=\"obj.key\">{{obj.value}}</option>\r\n          </select>\r\n        </div>\r\n\r\n        <div class=\"col-sm-1\">\r\n          <button (click)=\"submit()\" class=\"btn btn-primary\">\r\n            {{'Search' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <button (click)=\"forward('/shopping')\" type=\"button\" class=\"btn btn-success\">\r\n            {{'Add Shopping' | translate}}\r\n          </button>\r\n        </div>\r\n\r\n        <div class=\"col-sm-1\">\r\n          <button (click)=\"deleteMany()\" class=\"btn btn-danger\">\r\n            {{'Delete' | translate}}\r\n          </button>\r\n        </div>\r\n      </div>\r\n\r\n      <div *ngIf=\"form.error\" class=\"alert alert-danger alert-dismissible\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n        {{form.message}}\r\n      </div>\r\n      <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n        {{form.message}}\r\n      </div>\r\n      \r\n      <div class=\"table-responsive\">\r\n        <table class=\"table table-bordered table-hover font-weight-bold text-dark\">\r\n          <thead class=\"thead-dark text-uppercase \">\r\n            <tr align=\"center\">\r\n              <th><input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" name=\"list_name\" (change)=\"checkUncheckAll($event)\" /></th>\r\n              <th>{{'S.No' | translate}}</th>\r\n              <th>{{'Image' | translate}}</th>\r\n              <th>{{'Shopping Id' | translate}}</th>\r\n              <th>{{'Product Type' | translate}}</th>\r\n              <th>{{'Product name' | translate}}</th>\r\n              <th>{{'Shopping Date' | translate}}</th>\r\n              <th>{{'Payment' | translate}}</th>\r\n              <th>{{'Customer Name' | translate}}</th>\r\n              <th>{{'Amount' | translate}}</th>\r\n              <th>{{'Edit' | translate}}</th>\r\n            </tr>\r\n          </thead>\r\n          <tbody>\r\n            <tr *ngFor=\"let m of form.list; let i = index\" align=\"center\">\r\n              <td><input type=\"checkbox\" #checkboxes (change)=\"checklistUpdate()\" name=\"list_name\" [id]=\"m.id\" /></td>\r\n              <td>{{(form.pageNo * 5) + i + 1}}</td>\r\n              <td>\r\n                <div *ngIf=\"m.imageId\">\r\n                  <img src=\"http://localhost:8084/Shopping/profilePic/{{m.id}}\" height=\"55px\" width=\"80px\">\r\n                </div>\r\n                <div *ngIf=\"!m.imageId\">\r\n                  <img src=\"../../assets/files/default.jpg\" height=\"55px\" width=\"80px\">\r\n                </div>\r\n              </td>\r\n              <td>{{ m.shoppingId }}</td>\r\n              <td>{{ m.productType }}</td>\r\n              <td>{{ m.productName }}</td>\r\n              <td>{{ m.shoppingDate | date : 'dd-MM-yyyy' }}</td>\r\n              <td>{{ m.paymentName }}</td>\r\n              <td>{{ m.customerName }}</td>\r\n              <td>{{ m.amount }}</td>\r\n              <td>\r\n                <button class=\"fa fa-edit text-primary\" id=\"nnn\" (click)=\"forward('/shopping/' + m.id)\"></button>\r\n              </td>\r\n            </tr>\r\n          </tbody>\r\n        </table>\r\n\r\n        <div class=\"d-flex justify-content-between mt-3\">\r\n          <button (click)=\"previous()\" [disabled]=\"form.pageNo == 0\" class=\"btn btn-info\">{{'Previous' | translate }}</button>\r\n          <div *ngIf=\"form.list.length == 0\">\r\n            <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/shoppinglist']\" (click)=\"exit()\">{{'Back' | translate}}</a>\r\n          </div>\r\n          <button (click)=\"next()\" [disabled]=\"nextList == 0\" class=\"btn btn-info\">{{'Next' | translate }}</button>\r\n        </div>\r\n      </div>\r\n\r\n    </div>\r\n  </div>\r\n</div>\r\n<app-footer></app-footer>\r\n"

/***/ }),

/***/ "./src/app/shopping/shoppinglist.component.ts":
/*!****************************************************!*\
  !*** ./src/app/shopping/shoppinglist.component.ts ***!
  \****************************************************/
...
var ShoppinglistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ShoppinglistComponent, _super);
    function ShoppinglistComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.SHOPPING, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.httpClient = httpClient;
    ...
    ShoppinglistComponent.prototype.createImageFromBlob = function (image) {
        var _this = this;
        var reader = new FileReader();
        reader.addEventListener("load", function () {
            _this.imageToShow = reader.result;
    ...
    ShoppinglistComponent.prototype.getImage = function (id) {
        var _this = this;
        //Make a call to Sprinf Boot to get the Image Bytes.
        this.form.data.id = id;
        console.log(this.form.data.id);
        this.httpClient.get('http://localhost:8080/Shopping/profilePic/' + this.form.data.id, { responseType: 'blob' }).subscribe(function (data) {
            _this.createImageFromBlob(data);
            _this.myKey = _this.form.data.id;
        }, function (error) {
            console.log(error);
    ...
    ShoppinglistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./shoppinglist.component.html */ "./src/app/shopping/shoppinglist.component.html"),
            styles: [__webpack_require__(/*! ./shoppinglist.component.css */ "./src/app/shopping/shoppinglist.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]])
...
module.exports = __webpack_require__(/*! C:\Users\HP\Desktop\PROJECT_10_FCT\proect10_FrontCtl\ORSProject10-UI Fctl\src\main.ts */"./src/main.ts");
